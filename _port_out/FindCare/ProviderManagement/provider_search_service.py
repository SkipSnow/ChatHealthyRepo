...
class FindCareService:
    ...
    def _format_provider(self, p: dict) -> dict:
        ...
        primary = next((t for t in p.get("taxonomies", [])
                        if t.get("code") == p.get("primary_taxonomy_code")), None)
    ...
    _PROJECTION = {
        ...
        "practice_addresses": 1, "business_address": 1,
        "taxonomies": 1, "primary_taxonomy_code": 1,
    }
