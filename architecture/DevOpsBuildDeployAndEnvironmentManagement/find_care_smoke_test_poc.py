"""POC iteration smoke test - find_care_smoke_test.py with banner and
security-panel test classes removed. Generated by
_oneshots/strip_banner_security_tests.py. DO NOT hand-edit.
Re-run the generator after editing the source smoke."""
