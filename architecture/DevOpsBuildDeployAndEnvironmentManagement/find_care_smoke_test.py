...
class TestStep02:
    def test_banner_correct_values(self, env):
        pytest.skip("architecture POC: banner removed in new client-side architecture")
        if IS_PROD:
...
class TestStep17:
    def test_token_same_sent_received(self, env):
        pytest.skip("architecture POC: security panel removed in new client-side architecture")
        page = env["page"]
