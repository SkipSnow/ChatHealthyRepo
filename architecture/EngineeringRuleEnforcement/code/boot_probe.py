...
def _project_root() -> Path:
    """The repository root by its marker, not by counting parents.

    parents[4] was true only while this sat four levels down in
    Code/Shared/ops/tools. Code/ no longer exists, and a depth count is a
    claim about where a file lives.
    """
...
BRAIN_DIR = _project_root() / "brain" / "machine_artifacts" / "content"
