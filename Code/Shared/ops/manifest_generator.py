...
class ManifestGenerator:
    ...
    CAPABILITIES = {
        ...
        "FindCare/ProviderManagement/provider_search_models.py": ["Pydantic validation for provider search", "Pydantic validation for specialty queries"],
        ...
        "FindCare/ProviderManagement/provider_detail_service.py": ["NPI Registry CMS API lookup", "State medical board links (DE, MS, VA)", "Research site URL construction"],
        "FindCare/ProviderManagement/provider_search_service.py": ["MongoDB Atlas vector search (text-embedding-3-large)", "Taxonomy fallback with NUCC codes", "FIPS-to-county mapping (ASN-4AFBDA)", "Multi-stage state/city/county filtering"],
