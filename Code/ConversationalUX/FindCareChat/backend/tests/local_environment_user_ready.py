...
SCREENSHOT_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "..", "_oneshots/test_output", "user_ready")
...
class TestKnownGaps:
    ...
    def test_gap_https_redirect(self, shared_page):
        ...
        if not page.url.startswith("https://"):
            _record_bug("GAP-TLS-001-redirect", f"No HTTPS redirect. URL: {page.url}")
