...
# DEAD CODE (v4-031) -- unreferenced function 'enrich_providers_with_economics', marked for deletion
...
#         county.gdp_millions, county.median_income, county.mean_income,
...
#     bulk_ops = []
#
#     for fips, econ in economics.items():
#         update_fields = {}
#         for key, value in econ.items():
#             if value is not None:
#                 update_fields[f"county.{key}"] = value
#
#         if update_fields:
#             bulk_ops.append(
#                 UpdateMany(
