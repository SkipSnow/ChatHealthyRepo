...
#
# Requirements tested:
#   PIPE-DQ-004-REQ-001 through REQ-005: can_prescribe flag
...
class TestSpecialtyCompleteness:
    ...
    def test_all_have_can_prescribe(self, all_specialties):
        """Every specialty must have can_prescribe flag (PIPE-DQ-004-REQ-001)."""
...
class TestCrosswalkOnProviders:
    ...
    def test_providers_have_can_prescribe(self, providers_coll):
        ...
        has = providers_coll.count_documents({"practice_address.state": "DE", "can_prescribe": {"$exists": True}})
