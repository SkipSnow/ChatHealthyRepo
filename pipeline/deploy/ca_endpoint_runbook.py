...
# Wire Mongo logging BEFORE ChatHealthyLoggingService() singleton fires.
# See ca_bootstrap_runbook.py for the fallback-to-stderr contract.
os.environ.setdefault("CH_SPACE_NAME", "ca-endpoint")
os.environ.setdefault("CH_COMPONENT", "ca-endpoint")
