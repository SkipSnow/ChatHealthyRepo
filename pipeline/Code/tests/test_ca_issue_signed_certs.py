"""E2E Test: CA issues X.509 certs signed with root cert (REQ-B-001)"""
...
def test_ca_issues_signed_certificates(vault_url):
    """Test: CA issues X.509 certificates signed with root certificate."""
    cert_name = "test-ca-root-cert-req-s003"
    key_name = "test-ca-root-privatekey-req-s003"
    ...
    try:
        ...
        # Issue certificate
        subject_dn = "C=US,ST=California,L=SF,O=ChatHealthy,CN=signed-test.example.com"
